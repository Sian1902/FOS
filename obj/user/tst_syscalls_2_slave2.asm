...
_main(void)
{
  ...
  800048:	e8 79 18 00 00       	call   8018c6 <sys_allocate_user_mem>
  80004d:	83 c4 10             	add    $0x10,%esp
	inctst();
  800050:	e8 a6 16 00 00       	call   8016fb <inctst>
  ...
  800058:	68 60 1b 80 00       	push   $0x801b60
  80005d:	6a 0a                	push   $0xa
  80005f:	68 e2 1b 80 00       	push   $0x801be2
...
libmain(int argc, char **argv)
{
  ...
  80006f:	e8 49 15 00 00       	call   8015bd <sys_getenvindex>
  ...
  8000e3:	e8 e2 12 00 00       	call   8013ca <sys_disable_interrupt>
	cprintf("**************************************\n");
  8000e8:	83 ec 0c             	sub    $0xc,%esp
  8000eb:	68 18 1c 80 00       	push   $0x801c18
  ...
  800111:	52                   	push   %edx
  800112:	50                   	push   %eax
  800113:	68 40 1c 80 00       	push   $0x801c40
  ...
  800142:	52                   	push   %edx
  800143:	50                   	push   %eax
  800144:	68 68 1c 80 00       	push   $0x801c68
  ...
  80015f:	50                   	push   %eax
  800160:	68 c0 1c 80 00       	push   $0x801cc0
  800165:	e8 01 03 00 00       	call   80046b <cprintf>
  80016a:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  80016d:	83 ec 0c             	sub    $0xc,%esp
  800170:	68 18 1c 80 00       	push   $0x801c18
  800175:	e8 f1 02 00 00       	call   80046b <cprintf>
  80017a:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80017d:	e8 62 12 00 00       	call   8013e4 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800195:	e8 ef 13 00 00       	call   801589 <sys_destroy_env>
...
exit(void)
{
  ...
  8001a3:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8001a6:	e8 44 14 00 00       	call   8015ef <sys_exit_env>
}
  8001ab:	90                   	nop
  8001ac:	c9                   	leave  
  8001ad:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001ce:	50                   	push   %eax
  8001cf:	68 d4 1c 80 00       	push   $0x801cd4
  ...
  8001e7:	50                   	push   %eax
  8001e8:	68 d9 1c 80 00       	push   $0x801cd9
  ...
  80020c:	68 f5 1c 80 00       	push   $0x801cf5
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80023b:	68 f8 1c 80 00       	push   $0x801cf8
  800240:	6a 26                	push   $0x26
  800242:	68 44 1d 80 00       	push   $0x801d44
  ...
  800310:	68 50 1d 80 00       	push   $0x801d50
  800315:	6a 3a                	push   $0x3a
  800317:	68 44 1d 80 00       	push   $0x801d44
  ...
  800383:	68 a4 1d 80 00       	push   $0x801da4
  800388:	6a 44                	push   $0x44
  80038a:	68 44 1d 80 00       	push   $0x801d44
...
static void putch(int ch, struct printbuf *b) {
  ...
  8003db:	51                   	push   %ecx
  8003dc:	52                   	push   %edx
  8003dd:	e8 8f 0e 00 00       	call   801271 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800453:	50                   	push   %eax
  800454:	e8 18 0e 00 00       	call   801271 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80049b:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80049e:	e8 27 0f 00 00       	call   8013ca <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8004bb:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8004be:	e8 21 0f 00 00       	call   8013e4 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800508:	e8 d7 13 00 00       	call   8018e4 <__udivdi3>
  ...
  800556:	52                   	push   %edx
  800557:	50                   	push   %eax
  800558:	e8 97 14 00 00       	call   8019f4 <__umoddi3>
  80055d:	83 c4 10             	add    $0x10,%esp
  800560:	05 14 20 80 00       	add    $0x802014,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006b3:	8b 04 85 38 20 80 00 	mov    0x802038(,%eax,4),%eax
  ...
  800794:	8b 34 9d 80 1e 80 00 	mov    0x801e80(,%ebx,4),%esi
  80079b:	85 f6                	test   %esi,%esi
  80079d:	75 19                	jne    8007b8 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80079f:	53                   	push   %ebx
  8007a0:	68 25 20 80 00       	push   $0x802025
  ...
  8007b3:	e9 49 02 00 00       	jmp    800a01 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007b8:	56                   	push   %esi
  8007b9:	68 2e 20 80 00       	push   $0x80202e
  ...
  8007e4:	75 05                	jne    8007eb <vprintfmt+0x1a6>
				p = "(null)";
  8007e6:	be 31 20 80 00       	mov    $0x802031,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  8011fc:	75 3a                	jne    801238 <str2lower+0x43>
	return NULL;
  8011fe:	b8 00 00 00 00       	mov    $0x0,%eax
  801203:	eb 3f                	jmp    801244 <str2lower+0x4f>
	}
	while(*src!='\0'){
		if(*src>=65&&*src<=90){
  ...
  80123f:	75 c4                	jne    801205 <str2lower+0x10>
			*dst=*src;
		}
		src++;
		dst++;
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801258:	8b 5d 14             	mov    0x14(%ebp),%ebx
  80125b:	8b 7d 18             	mov    0x18(%ebp),%edi
  80125e:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  80128f:	e8 b2 ff ff ff       	call   801246 <syscall>
...
sys_cgetc(void)
{
  ...
  8012a9:	e8 98 ff ff ff       	call   801246 <syscall>
  8012ae:	83 c4 18             	add    $0x18,%esp
}
  8012b1:	c9                   	leave  
  8012b2:	c3                   	ret    

008012b3 <__sys_allocate_page>:
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  8012c2:	52                   	push   %edx
  8012c3:	50                   	push   %eax
  8012c4:	6a 05                	push   $0x5
  8012c6:	e8 7b ff ff ff       	call   801246 <syscall>
  8012cb:	83 c4 18             	add    $0x18,%esp
}
  8012ce:	c9                   	leave  
  8012cf:	c3                   	ret    

008012d0 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  8012e7:	52                   	push   %edx
  8012e8:	50                   	push   %eax
  8012e9:	6a 06                	push   $0x6
  8012eb:	e8 56 ff ff ff       	call   801246 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  80130d:	e8 34 ff ff ff       	call   801246 <syscall>
  801312:	83 c4 18             	add    $0x18,%esp
}
  801315:	c9                   	leave  
  801316:	c3                   	ret    

00801317 <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801326:	6a 08                	push   $0x8
  801328:	e8 19 ff ff ff       	call   801246 <syscall>
  80132d:	83 c4 18             	add    $0x18,%esp
}
  801330:	c9                   	leave  
  801331:	c3                   	ret    

00801332 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  80133f:	6a 09                	push   $0x9
  801341:	e8 00 ff ff ff       	call   801246 <syscall>
  801346:	83 c4 18             	add    $0x18,%esp
}
  801349:	c9                   	leave  
  80134a:	c3                   	ret    

0080134b <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801358:	6a 0a                	push   $0xa
  80135a:	e8 e7 fe ff ff       	call   801246 <syscall>
  80135f:	83 c4 18             	add    $0x18,%esp
}
  801362:	c9                   	leave  
  801363:	c3                   	ret    

00801364 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801371:	6a 0b                	push   $0xb
  801373:	e8 ce fe ff ff       	call   801246 <syscall>
  801378:	83 c4 18             	add    $0x18,%esp
}
  80137b:	c9                   	leave  
  80137c:	c3                   	ret    

0080137d <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80138a:	6a 0c                	push   $0xc
  80138c:	e8 b5 fe ff ff       	call   801246 <syscall>
  801391:	83 c4 18             	add    $0x18,%esp
}
  801394:	c9                   	leave  
  801395:	c3                   	ret    

00801396 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  8013a6:	e8 9b fe ff ff       	call   801246 <syscall>
  8013ab:	83 c4 18             	add    $0x18,%esp
}
  8013ae:	c9                   	leave  
  8013af:	c3                   	ret    

008013b0 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  8013bd:	6a 0e                	push   $0xe
  8013bf:	e8 82 fe ff ff       	call   801246 <syscall>
...
008013ca <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8013d9:	e8 68 fe ff ff       	call   801246 <syscall>
...
sys_enable_interrupt()
{
  ...
  8013f1:	6a 12                	push   $0x12
  8013f3:	e8 4e fe ff ff       	call   801246 <syscall>
...
sys_cputc(const char c)
{
  ...
  801419:	e8 28 fe ff ff       	call   801246 <syscall>
...
sys_clear_ffl()
{
  ...
  801431:	6a 14                	push   $0x14
  801433:	e8 0e fe ff ff       	call   801246 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  80144d:	50                   	push   %eax
  80144e:	6a 15                	push   $0x15
  801450:	e8 f1 fd ff ff       	call   801246 <syscall>
  801455:	83 c4 18             	add    $0x18,%esp
}
  801458:	c9                   	leave  
  801459:	c3                   	ret    

0080145a <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80146d:	e8 d4 fd ff ff       	call   801246 <syscall>
  801472:	83 c4 18             	add    $0x18,%esp
}
  801475:	c9                   	leave  
  801476:	c3                   	ret    

00801477 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80148a:	e8 b7 fd ff ff       	call   801246 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8014a8:	e8 99 fd ff ff       	call   801246 <syscall>
...
008014b3 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8014bf:	8b 4d 14             	mov    0x14(%ebp),%ecx
  ...
  8014d0:	50                   	push   %eax
  8014d1:	6a 19                	push   $0x19
  8014d3:	e8 6e fd ff ff       	call   801246 <syscall>
  8014d8:	83 c4 18             	add    $0x18,%esp
}
  8014db:	c9                   	leave  
  8014dc:	c3                   	ret    

008014dd <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8014ec:	52                   	push   %edx
  8014ed:	50                   	push   %eax
  8014ee:	6a 1a                	push   $0x1a
  8014f0:	e8 51 fd ff ff       	call   801246 <syscall>
  8014f5:	83 c4 18             	add    $0x18,%esp
}
  8014f8:	c9                   	leave  
  8014f9:	c3                   	ret    

008014fa <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  80150b:	52                   	push   %edx
  80150c:	50                   	push   %eax
  80150d:	6a 1b                	push   $0x1b
  80150f:	e8 32 fd ff ff       	call   801246 <syscall>
  801514:	83 c4 18             	add    $0x18,%esp
}
  801517:	c9                   	leave  
  801518:	c3                   	ret    

00801519 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  80152c:	e8 15 fd ff ff       	call   801246 <syscall>
  801531:	83 c4 18             	add    $0x18,%esp
}
  801534:	c9                   	leave  
  801535:	c3                   	ret    

00801536 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801545:	e8 fc fc ff ff       	call   801246 <syscall>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  801560:	50                   	push   %eax
  801561:	6a 1e                	push   $0x1e
  801563:	e8 de fc ff ff       	call   801246 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  80157b:	50                   	push   %eax
  80157c:	6a 1f                	push   $0x1f
  80157e:	e8 c3 fc ff ff       	call   801246 <syscall>
...
int sys_destroy_env(int32  envid)
{
  ...
  801597:	50                   	push   %eax
  801598:	6a 20                	push   $0x20
  80159a:	e8 a7 fc ff ff       	call   801246 <syscall>
...
int32 sys_getenvid(void)
{
  ...
  8015b1:	6a 02                	push   $0x2
  8015b3:	e8 8e fc ff ff       	call   801246 <syscall>
...
int32 sys_getenvindex(void)
{
  ...
  8015ca:	6a 03                	push   $0x3
  8015cc:	e8 75 fc ff ff       	call   801246 <syscall>
...
int32 sys_getparentenvid(void)
{
  ...
  8015e3:	6a 04                	push   $0x4
  8015e5:	e8 5c fc ff ff       	call   801246 <syscall>
...
void sys_exit_env(void)
{
  ...
  8015fe:	e8 43 fc ff ff       	call   801246 <syscall>
...
sys_get_virtual_time()
{
  ...
  801622:	e8 1f fc ff ff       	call   801246 <syscall>
...
void sys_move_user_mem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801651:	e8 f0 fb ff ff       	call   801246 <syscall>
...
uint32 sys_rcr2()
{
  ...
  80166b:	e8 d6 fb ff ff       	call   801246 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  80168d:	50                   	push   %eax
  80168e:	6a 24                	push   $0x24
  801690:	e8 b1 fb ff ff       	call   801246 <syscall>
...
void rsttst()
{
  ...
  8016aa:	e8 97 fb ff ff       	call   801246 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  8016d5:	e8 6c fb ff ff       	call   801246 <syscall>
...
void chktst(uint32 n)
{
  ...
  8016ee:	6a 27                	push   $0x27
  8016f0:	e8 51 fb ff ff       	call   801246 <syscall>
...
void inctst()
{
  ...
  80170a:	e8 37 fb ff ff       	call   801246 <syscall>
...
uint32 gettst()
{
  ...
  801722:	6a 29                	push   $0x29
  801724:	e8 1d fb ff ff       	call   801246 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801740:	e8 01 fb ff ff       	call   801246 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801771:	e8 d0 fa ff ff       	call   801246 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  8017a2:	e8 9f fa ff ff       	call   801246 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  8017d3:	e8 6e fa ff ff       	call   801246 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  801800:	6a 2b                	push   $0x2b
  801802:	e8 3f fa ff ff       	call   801246 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  801821:	52                   	push   %edx
  801822:	50                   	push   %eax
  801823:	6a 2c                	push   $0x2c
  801825:	e8 1c fa ff ff       	call   801246 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  801841:	52                   	push   %edx
  801842:	50                   	push   %eax
  801843:	6a 2d                	push   $0x2d
  801845:	e8 fc f9 ff ff       	call   801246 <syscall>
...
int sys_check_WS_list(uint32* WS_list_content, int actual_WS_list_size, uint32 last_WS_element_content, bool chk_in_order)
{
  ...
  801865:	e8 dc f9 ff ff       	call   801246 <syscall>
...
void sys_allocate_chunk(uint32 virtual_address, uint32 size, uint32 perms)
{
  ...
  801881:	e8 c0 f9 ff ff       	call   801246 <syscall>
...
void* sys_sbrk(int increment)
{
  ...
  801895:	68 90 21 80 00       	push   $0x802190
  80189a:	68 54 01 00 00       	push   $0x154
  80189f:	68 a4 21 80 00       	push   $0x8021a4
  8018a4:	e8 05 e9 ff ff       	call   8001ae <_panic>

008018a9 <sys_free_user_mem>:
	return NULL;
}
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8018b2:	68 90 21 80 00       	push   $0x802190
  8018b7:	68 5b 01 00 00       	push   $0x15b
  8018bc:	68 a4 21 80 00       	push   $0x8021a4
  8018c1:	e8 e8 e8 ff ff       	call   8001ae <_panic>

008018c6 <sys_allocate_user_mem>:
}
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8018cf:	68 90 21 80 00       	push   $0x802190
  8018d4:	68 61 01 00 00       	push   $0x161
  8018d9:	68 a4 21 80 00       	push   $0x8021a4
  8018de:	e8 cb e8 ff ff       	call   8001ae <_panic>
  8018e3:	90                   	nop
