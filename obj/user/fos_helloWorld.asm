...
char* str2lower(char *dst, const char *src)
{
  ...
  801022:	e8 9e 06 00 00       	call   8016c5 <_panic>
...
void* sys_sbrk(int increment)
{
  ...
  80167b:	50                   	push   %eax
  80167c:	6a 2f                	push   $0x2f
  80167e:	e8 a4 f9 ff ff       	call   801027 <syscall>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  80169c:	6a 30                	push   $0x30
  80169e:	e8 84 f9 ff ff       	call   801027 <syscall>
...
008016a9 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8016b8:	6a 31                	push   $0x31
  8016ba:	e8 68 f9 ff ff       	call   801027 <syscall>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8016c8:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8016cb:	8d 45 10             	lea    0x10(%ebp),%eax
  8016ce:	83 c0 04             	add    $0x4,%eax
  8016d1:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8016d4:	a1 18 31 80 00       	mov    0x803118,%eax
  8016d9:	85 c0                	test   %eax,%eax
  8016db:	74 16                	je     8016f3 <_panic+0x2e>
		cprintf("%s: ", argv0);
  8016dd:	a1 18 31 80 00       	mov    0x803118,%eax
  8016e2:	83 ec 08             	sub    $0x8,%esp
  8016e5:	50                   	push   %eax
  8016e6:	68 04 20 80 00       	push   $0x802004
  8016eb:	e8 90 eb ff ff       	call   800280 <cprintf>
  8016f0:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  8016f3:	a1 00 30 80 00       	mov    0x803000,%eax
  8016f8:	ff 75 0c             	pushl  0xc(%ebp)
  8016fb:	ff 75 08             	pushl  0x8(%ebp)
  8016fe:	50                   	push   %eax
  8016ff:	68 09 20 80 00       	push   $0x802009
  801704:	e8 77 eb ff ff       	call   800280 <cprintf>
  ...
  801715:	50                   	push   %eax
  801716:	e8 fa ea ff ff       	call   800215 <vcprintf>
  80171b:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  80171e:	83 ec 08             	sub    $0x8,%esp
  801721:	6a 00                	push   $0x0
  801723:	68 25 20 80 00       	push   $0x802025
  801728:	e8 e8 ea ff ff       	call   800215 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801730:	e8 69 ea ff ff       	call   80019e <exit>

	// should not return here
	while (1) ;
  801735:	eb fe                	jmp    801735 <_panic+0x70>

00801737 <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80173d:	a1 20 30 80 00       	mov    0x803020,%eax
  801742:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801748:	8b 45 0c             	mov    0xc(%ebp),%eax
  80174b:	39 c2                	cmp    %eax,%edx
  80174d:	74 14                	je     801763 <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  80174f:	83 ec 04             	sub    $0x4,%esp
  801752:	68 28 20 80 00       	push   $0x802028
  801757:	6a 26                	push   $0x26
  801759:	68 74 20 80 00       	push   $0x802074
  80175e:	e8 62 ff ff ff       	call   8016c5 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  801763:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  80176a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801771:	e9 c5 00 00 00       	jmp    80183b <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  801776:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801779:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801780:	8b 45 08             	mov    0x8(%ebp),%eax
  801783:	01 d0                	add    %edx,%eax
  801785:	8b 00                	mov    (%eax),%eax
  801787:	85 c0                	test   %eax,%eax
  801789:	75 08                	jne    801793 <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  80178b:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  80178e:	e9 a5 00 00 00       	jmp    801838 <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  801793:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80179a:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  8017a1:	eb 69                	jmp    80180c <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  8017a3:	a1 20 30 80 00       	mov    0x803020,%eax
  8017a8:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  8017ae:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8017b1:	89 d0                	mov    %edx,%eax
  8017b3:	01 c0                	add    %eax,%eax
  8017b5:	01 d0                	add    %edx,%eax
  8017b7:	c1 e0 03             	shl    $0x3,%eax
  8017ba:	01 c8                	add    %ecx,%eax
  8017bc:	8a 40 04             	mov    0x4(%eax),%al
  8017bf:	84 c0                	test   %al,%al
  8017c1:	75 46                	jne    801809 <CheckWSArrayWithoutLastIndex+0xd2>
  ...
  8017de:	89 45 dc             	mov    %eax,-0x24(%ebp)
  8017e1:	8b 45 dc             	mov    -0x24(%ebp),%eax
  8017e4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  8017e9:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  8017eb:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017ee:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  8017fe:	75 09                	jne    801809 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  801800:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801807:	eb 15                	jmp    80181e <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801809:	ff 45 e8             	incl   -0x18(%ebp)
  80180c:	a1 20 30 80 00       	mov    0x803020,%eax
  801811:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801817:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80181a:	39 c2                	cmp    %eax,%edx
  80181c:	77 85                	ja     8017a3 <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
  ...
  801822:	75 14                	jne    801838 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  801824:	83 ec 04             	sub    $0x4,%esp
  801827:	68 80 20 80 00       	push   $0x802080
  80182c:	6a 3a                	push   $0x3a
  80182e:	68 74 20 80 00       	push   $0x802074
  801833:	e8 8d fe ff ff       	call   8016c5 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801838:	ff 45 f0             	incl   -0x10(%ebp)
  80183b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80183e:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801841:	0f 8c 2f ff ff ff    	jl     801776 <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  801847:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80184e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801855:	eb 26                	jmp    80187d <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801857:	a1 20 30 80 00       	mov    0x803020,%eax
  80185c:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  801862:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801865:	89 d0                	mov    %edx,%eax
  801867:	01 c0                	add    %eax,%eax
  801869:	01 d0                	add    %edx,%eax
  80186b:	c1 e0 03             	shl    $0x3,%eax
  80186e:	01 c8                	add    %ecx,%eax
  801870:	8a 40 04             	mov    0x4(%eax),%al
  801873:	3c 01                	cmp    $0x1,%al
  801875:	75 03                	jne    80187a <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  801877:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80187a:	ff 45 e0             	incl   -0x20(%ebp)
  80187d:	a1 20 30 80 00       	mov    0x803020,%eax
  801882:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801888:	8b 45 e0             	mov    -0x20(%ebp),%eax
  80188b:	39 c2                	cmp    %eax,%edx
  80188d:	77 c8                	ja     801857 <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801892:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  801895:	74 14                	je     8018ab <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  801897:	83 ec 04             	sub    $0x4,%esp
  80189a:	68 d4 20 80 00       	push   $0x8020d4
  80189f:	6a 44                	push   $0x44
  8018a1:	68 74 20 80 00       	push   $0x802074
  8018a6:	e8 1a fe ff ff       	call   8016c5 <_panic>
