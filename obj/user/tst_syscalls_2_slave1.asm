...
_main(void)
{
  ...
  800045:	e8 98 18 00 00       	call   8018e2 <sys_allocate_user_mem>
  80004a:	83 c4 10             	add    $0x10,%esp
	inctst();
  80004d:	e8 c8 16 00 00       	call   80171a <inctst>
...
libmain(int argc, char **argv)
{
  ...
  80006c:	e8 6b 15 00 00       	call   8015dc <sys_getenvindex>
  ...
  8000e0:	e8 04 13 00 00       	call   8013e9 <sys_disable_interrupt>
	cprintf("**************************************\n");
  8000e5:	83 ec 0c             	sub    $0xc,%esp
  8000e8:	68 38 1c 80 00       	push   $0x801c38
  ...
  80010e:	52                   	push   %edx
  80010f:	50                   	push   %eax
  800110:	68 60 1c 80 00       	push   $0x801c60
  ...
  80013f:	52                   	push   %edx
  800140:	50                   	push   %eax
  800141:	68 88 1c 80 00       	push   $0x801c88
  ...
  80015c:	50                   	push   %eax
  80015d:	68 e0 1c 80 00       	push   $0x801ce0
  800162:	e8 01 03 00 00       	call   800468 <cprintf>
  800167:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  80016a:	83 ec 0c             	sub    $0xc,%esp
  80016d:	68 38 1c 80 00       	push   $0x801c38
  800172:	e8 f1 02 00 00       	call   800468 <cprintf>
  800177:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80017a:	e8 84 12 00 00       	call   801403 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800192:	e8 11 14 00 00       	call   8015a8 <sys_destroy_env>
...
exit(void)
{
  ...
  8001a0:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8001a3:	e8 66 14 00 00       	call   80160e <sys_exit_env>
}
  8001a8:	90                   	nop
  8001a9:	c9                   	leave  
  8001aa:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8001cb:	50                   	push   %eax
  8001cc:	68 f4 1c 80 00       	push   $0x801cf4
  ...
  8001e4:	50                   	push   %eax
  8001e5:	68 f9 1c 80 00       	push   $0x801cf9
  ...
  800209:	68 15 1d 80 00       	push   $0x801d15
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800238:	68 18 1d 80 00       	push   $0x801d18
  80023d:	6a 26                	push   $0x26
  80023f:	68 64 1d 80 00       	push   $0x801d64
  ...
  80030d:	68 70 1d 80 00       	push   $0x801d70
  800312:	6a 3a                	push   $0x3a
  800314:	68 64 1d 80 00       	push   $0x801d64
  ...
  800380:	68 c4 1d 80 00       	push   $0x801dc4
  800385:	6a 44                	push   $0x44
  800387:	68 64 1d 80 00       	push   $0x801d64
...
static void putch(int ch, struct printbuf *b) {
  ...
  8003d8:	51                   	push   %ecx
  8003d9:	52                   	push   %edx
  8003da:	e8 b1 0e 00 00       	call   801290 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800450:	50                   	push   %eax
  800451:	e8 3a 0e 00 00       	call   801290 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800498:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80049b:	e8 49 0f 00 00       	call   8013e9 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8004b8:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8004bb:	e8 43 0f 00 00       	call   801403 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800505:	e8 f6 13 00 00       	call   801900 <__udivdi3>
  ...
  800553:	52                   	push   %edx
  800554:	50                   	push   %eax
  800555:	e8 b6 14 00 00       	call   801a10 <__umoddi3>
  80055a:	83 c4 10             	add    $0x10,%esp
  80055d:	05 34 20 80 00       	add    $0x802034,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8006b0:	8b 04 85 58 20 80 00 	mov    0x802058(,%eax,4),%eax
  ...
  800791:	8b 34 9d a0 1e 80 00 	mov    0x801ea0(,%ebx,4),%esi
  800798:	85 f6                	test   %esi,%esi
  80079a:	75 19                	jne    8007b5 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80079c:	53                   	push   %ebx
  80079d:	68 45 20 80 00       	push   $0x802045
  ...
  8007b0:	e9 49 02 00 00       	jmp    8009fe <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8007b5:	56                   	push   %esi
  8007b6:	68 4e 20 80 00       	push   $0x80204e
  ...
  8007e1:	75 05                	jne    8007e8 <vprintfmt+0x1a6>
				p = "(null)";
  8007e3:	be 51 20 80 00       	mov    $0x802051,%esi
			if (width > 0 && padc != '-')
...
memset(void *v, int c, uint32 n)
{
  ...
  800cdb:	83 ec 10             	sub    $0x10,%esp
	...
	i++;
  800cde:	a1 28 30 80 00       	mov    0x803028,%eax
  800ce3:	40                   	inc    %eax
  800ce4:	a3 28 30 80 00       	mov    %eax,0x803028
  ...
  800cf2:	89 45 f8             	mov    %eax,-0x8(%ebp)
	...
	while (--m >= 0){
  800cf5:	eb 0e                	jmp    800d05 <memset+0x2d>

		*p++ = c;
  800cf7:	8b 45 fc             	mov    -0x4(%ebp),%eax
  800cfa:	8d 50 01             	lea    0x1(%eax),%edx
  800cfd:	89 55 fc             	mov    %edx,-0x4(%ebp)
  ...
  800d03:	88 10                	mov    %dl,(%eax)
	...
	while (--m >= 0){
  800d05:	ff 4d f8             	decl   -0x8(%ebp)
  800d08:	83 7d f8 00          	cmpl   $0x0,-0x8(%ebp)
  800d0c:	79 e9                	jns    800cf7 <memset+0x1f>
...
memcpy(void *dst, const void *src, uint32 n)
{
  ...
  800d43:	89 55 10             	mov    %edx,0x10(%ebp)
  800d46:	85 c0                	test   %eax,%eax
  800d48:	75 dd                	jne    800d27 <memcpy+0x14>
		*d++ = *s++;
...
memmove(void *dst, const void *src, uint32 n)
{
  ...
  800d67:	73 50                	jae    800db9 <memmove+0x6a>
  800d69:	8b 55 fc             	mov    -0x4(%ebp),%edx
  800d6c:	8b 45 10             	mov    0x10(%ebp),%eax
  800d6f:	01 d0                	add    %edx,%eax
  800d71:	3b 45 f8             	cmp    -0x8(%ebp),%eax
  800d74:	76 43                	jbe    800db9 <memmove+0x6a>
		s += n;
  800d76:	8b 45 10             	mov    0x10(%ebp),%eax
  800d79:	01 45 fc             	add    %eax,-0x4(%ebp)
		d += n;
  800d7c:	8b 45 10             	mov    0x10(%ebp),%eax
  800d7f:	01 45 f8             	add    %eax,-0x8(%ebp)
		while (n-- > 0)
  800d82:	eb 10                	jmp    800d94 <memmove+0x45>
			*--d = *--s;
  800d84:	ff 4d f8             	decl   -0x8(%ebp)
  800d87:	ff 4d fc             	decl   -0x4(%ebp)
  ...
  800d9f:	75 e3                	jne    800d84 <memmove+0x35>
	const char *s;
	char *d;
	...
	d = dst;
	if (s < d && s + n > d) {
  800da1:	eb 23                	jmp    800dc6 <memmove+0x77>
		d += n;
		while (n-- > 0)
			*--d = *--s;
	} else
  ...
  800dc4:	75 dd                	jne    800da3 <memmove+0x54>
			*d++ = *s++;
...
memcmp(const void *v1, const void *v2, uint32 n)
{
  ...
  800e01:	eb 18                	jmp    800e1b <memcmp+0x50>
		s1++, s2++;
  800e03:	ff 45 fc             	incl   -0x4(%ebp)
  800e06:	ff 45 f8             	incl   -0x8(%ebp)
memcmp(const void *v1, const void *v2, uint32 n)
{
	const uint8 *s1 = (const uint8 *) v1;
	const uint8 *s2 = (const uint8 *) v2;
  ...
  800e0c:	8d 50 ff             	lea    -0x1(%eax),%edx
  800e0f:	89 55 10             	mov    %edx,0x10(%ebp)
  800e12:	85 c0                	test   %eax,%eax
  800e14:	75 c9                	jne    800ddf <memcmp+0x14>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
memfind(const void *s, int c, uint32 n)
{
  ...
  800e2b:	89 45 fc             	mov    %eax,-0x4(%ebp)
	for (; s < ends; s++)
  800e2e:	eb 15                	jmp    800e45 <memfind+0x28>
  ...
  800e3e:	39 c2                	cmp    %eax,%edx
  800e40:	74 0d                	je     800e4f <memfind+0x32>
...
memfind(const void *s, int c, uint32 n)
{
  ...
  800e48:	3b 45 fc             	cmp    -0x4(%ebp),%eax
  800e4b:	72 e3                	jb     800e30 <memfind+0x13>
  800e4d:	eb 01                	jmp    800e50 <memfind+0x33>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
  800e4f:	90                   	nop
	return (void *) s;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800e62:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
	...
	while (*s == ' ' || *s == '\t')
  800e69:	eb 03                	jmp    800e6e <strtol+0x19>
		s++;
  800e6b:	ff 45 08             	incl   0x8(%ebp)
{
  ...
  800e75:	74 f4                	je     800e6b <strtol+0x16>
  800e77:	8b 45 08             	mov    0x8(%ebp),%eax
  800e7a:	8a 00                	mov    (%eax),%al
  800e7c:	3c 09                	cmp    $0x9,%al
  800e7e:	74 eb                	je     800e6b <strtol+0x16>
		s++;
  ...
  800e85:	3c 2b                	cmp    $0x2b,%al
  800e87:	75 05                	jne    800e8e <strtol+0x39>
		s++;
  800e89:	ff 45 08             	incl   0x8(%ebp)
  800e8c:	eb 13                	jmp    800ea1 <strtol+0x4c>
	else if (*s == '-')
  800e8e:	8b 45 08             	mov    0x8(%ebp),%eax
  800e91:	8a 00                	mov    (%eax),%al
  800e93:	3c 2d                	cmp    $0x2d,%al
  800e95:	75 0a                	jne    800ea1 <strtol+0x4c>
		s++, neg = 1;
  ...
  800ea5:	74 06                	je     800ead <strtol+0x58>
  800ea7:	83 7d 10 10          	cmpl   $0x10,0x10(%ebp)
  800eab:	75 20                	jne    800ecd <strtol+0x78>
  800ead:	8b 45 08             	mov    0x8(%ebp),%eax
  800eb0:	8a 00                	mov    (%eax),%al
  800eb2:	3c 30                	cmp    $0x30,%al
  800eb4:	75 17                	jne    800ecd <strtol+0x78>
  800eb6:	8b 45 08             	mov    0x8(%ebp),%eax
  800eb9:	40                   	inc    %eax
  800eba:	8a 00                	mov    (%eax),%al
  800ebc:	3c 78                	cmp    $0x78,%al
  800ebe:	75 0d                	jne    800ecd <strtol+0x78>
		s += 2, base = 16;
  800ec0:	83 45 08 02          	addl   $0x2,0x8(%ebp)
  800ec4:	c7 45 10 10 00 00 00 	movl   $0x10,0x10(%ebp)
  800ecb:	eb 28                	jmp    800ef5 <strtol+0xa0>
	else if (base == 0 && s[0] == '0')
  800ecd:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  800ed1:	75 15                	jne    800ee8 <strtol+0x93>
  800ed3:	8b 45 08             	mov    0x8(%ebp),%eax
  800ed6:	8a 00                	mov    (%eax),%al
  800ed8:	3c 30                	cmp    $0x30,%al
  800eda:	75 0c                	jne    800ee8 <strtol+0x93>
		s++, base = 8;
  800edc:	ff 45 08             	incl   0x8(%ebp)
  800edf:	c7 45 10 08 00 00 00 	movl   $0x8,0x10(%ebp)
  800ee6:	eb 0d                	jmp    800ef5 <strtol+0xa0>
	else if (base == 0)
  800ee8:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
  800eec:	75 07                	jne    800ef5 <strtol+0xa0>
		base = 10;
  800eee:	c7 45 10 0a 00 00 00 	movl   $0xa,0x10(%ebp)
  ...
  800efa:	3c 2f                	cmp    $0x2f,%al
  800efc:	7e 19                	jle    800f17 <strtol+0xc2>
  800efe:	8b 45 08             	mov    0x8(%ebp),%eax
  800f01:	8a 00                	mov    (%eax),%al
  800f03:	3c 39                	cmp    $0x39,%al
  800f05:	7f 10                	jg     800f17 <strtol+0xc2>
			dig = *s - '0';
  800f07:	8b 45 08             	mov    0x8(%ebp),%eax
  800f0a:	8a 00                	mov    (%eax),%al
  800f0c:	0f be c0             	movsbl %al,%eax
  800f0f:	83 e8 30             	sub    $0x30,%eax
  800f12:	89 45 f4             	mov    %eax,-0xc(%ebp)
  800f15:	eb 42                	jmp    800f59 <strtol+0x104>
		else if (*s >= 'a' && *s <= 'z')
  800f17:	8b 45 08             	mov    0x8(%ebp),%eax
  800f1a:	8a 00                	mov    (%eax),%al
  800f1c:	3c 60                	cmp    $0x60,%al
  800f1e:	7e 19                	jle    800f39 <strtol+0xe4>
  800f20:	8b 45 08             	mov    0x8(%ebp),%eax
  800f23:	8a 00                	mov    (%eax),%al
  800f25:	3c 7a                	cmp    $0x7a,%al
  800f27:	7f 10                	jg     800f39 <strtol+0xe4>
			dig = *s - 'a' + 10;
  800f29:	8b 45 08             	mov    0x8(%ebp),%eax
  800f2c:	8a 00                	mov    (%eax),%al
  800f2e:	0f be c0             	movsbl %al,%eax
  800f31:	83 e8 57             	sub    $0x57,%eax
  800f34:	89 45 f4             	mov    %eax,-0xc(%ebp)
  800f37:	eb 20                	jmp    800f59 <strtol+0x104>
		else if (*s >= 'A' && *s <= 'Z')
  800f39:	8b 45 08             	mov    0x8(%ebp),%eax
  800f3c:	8a 00                	mov    (%eax),%al
  800f3e:	3c 40                	cmp    $0x40,%al
  800f40:	7e 39                	jle    800f7b <strtol+0x126>
  800f42:	8b 45 08             	mov    0x8(%ebp),%eax
  800f45:	8a 00                	mov    (%eax),%al
  800f47:	3c 5a                	cmp    $0x5a,%al
  800f49:	7f 30                	jg     800f7b <strtol+0x126>
			dig = *s - 'A' + 10;
  800f4b:	8b 45 08             	mov    0x8(%ebp),%eax
  800f4e:	8a 00                	mov    (%eax),%al
  800f50:	0f be c0             	movsbl %al,%eax
  800f53:	83 e8 37             	sub    $0x37,%eax
  800f56:	89 45 f4             	mov    %eax,-0xc(%ebp)
		else
			break;
		if (dig >= base)
  800f59:	8b 45 f4             	mov    -0xc(%ebp),%eax
  800f5c:	3b 45 10             	cmp    0x10(%ebp),%eax
  800f5f:	7d 19                	jge    800f7a <strtol+0x125>
			break;
		s++, val = (val * base) + dig;
  800f61:	ff 45 08             	incl   0x8(%ebp)
  800f64:	8b 45 f8             	mov    -0x8(%ebp),%eax
  800f67:	0f af 45 10          	imul   0x10(%ebp),%eax
  ...
  800f75:	e9 7b ff ff ff       	jmp    800ef5 <strtol+0xa0>
		else if (*s >= 'A' && *s <= 'Z')
			dig = *s - 'A' + 10;
		else
			break;
  ...
  800f7f:	74 08                	je     800f89 <strtol+0x134>
		*endptr = (char *) s;
  800f81:	8b 45 0c             	mov    0xc(%ebp),%eax
  800f84:	8b 55 08             	mov    0x8(%ebp),%edx
  800f87:	89 10                	mov    %edx,(%eax)
	return (neg ? -val : val);
  800f89:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
  800f8d:	74 07                	je     800f96 <strtol+0x141>
  800f8f:	8b 45 f8             	mov    -0x8(%ebp),%eax
  800f92:	f7 d8                	neg    %eax
  800f94:	eb 03                	jmp    800f99 <strtol+0x144>
...
ltostr(long value, char *str)
{
  ...
  800fb3:	79 13                	jns    800fc8 <ltostr+0x2d>
	{
		neg = 1;
  800fb5:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%ebp)
		str[0] = '-';
  800fbc:	8b 45 0c             	mov    0xc(%ebp),%eax
  800fbf:	c6 00 2d             	movb   $0x2d,(%eax)
		value = value * -1 ;
  800fc2:	f7 5d 08             	negl   0x8(%ebp)
		s++ ;
  ...
  800fcb:	b9 0a 00 00 00       	mov    $0xa,%ecx
  800fd0:	99                   	cltd   
  800fd1:	f7 f9                	idiv   %ecx
  800fd3:	89 55 ec             	mov    %edx,-0x14(%ebp)
		str[s++] = mod + '0' ;
  ...
  800fe6:	8b 55 ec             	mov    -0x14(%ebp),%edx
  800fe9:	83 c2 30             	add    $0x30,%edx
  ...
  801004:	89 45 08             	mov    %eax,0x8(%ebp)
	} while (value % 10 != 0);
  801007:	8b 4d 08             	mov    0x8(%ebp),%ecx
  80100a:	b8 67 66 66 66       	mov    $0x66666667,%eax
  80100f:	f7 e9                	imul   %ecx
  801011:	c1 fa 02             	sar    $0x2,%edx
  801014:	89 c8                	mov    %ecx,%eax
  801016:	c1 f8 1f             	sar    $0x1f,%eax
  801019:	29 c2                	sub    %eax,%edx
  80101b:	89 d0                	mov    %edx,%eax
  80101d:	c1 e0 02             	shl    $0x2,%eax
  801020:	01 d0                	add    %edx,%eax
  801022:	01 c0                	add    %eax,%eax
  801024:	29 c1                	sub    %eax,%ecx
  801026:	89 ca                	mov    %ecx,%edx
  801028:	85 d2                	test   %edx,%edx
  80102a:	75 9c                	jne    800fc8 <ltostr+0x2d>
  ...
  80103e:	74 3d                	je     80107d <ltostr+0xe2>
		start = 1 ;
  801040:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%ebp)
	while(start<end)
  801047:	eb 34                	jmp    80107d <ltostr+0xe2>
	{
		char tmp = str[start] ;
  ...
  801053:	88 45 eb             	mov    %al,-0x15(%ebp)
		str[start] = str[end] ;
  ...
  801072:	8a 45 eb             	mov    -0x15(%ebp),%al
  801075:	88 02                	mov    %al,(%edx)
		start++ ;
  801077:	ff 45 f4             	incl   -0xc(%ebp)
		end-- ;
  80107a:	ff 4d f0             	decl   -0x10(%ebp)
	//reverse the string
	int start = 0 ;
	int end = s-1 ;
	if (neg)
  ...
  801083:	7c c4                	jl     801049 <ltostr+0xae>
		str[end] = tmp;
		start++ ;
		end-- ;
	}
	...
	str[s] = 0 ;
  801085:	8b 55 f8             	mov    -0x8(%ebp),%edx
...
strcconcat(const char *str1, const char *str2, char *final)
{
  ...
  8010c3:	eb 17                	jmp    8010dc <strcconcat+0x49>
		final[s] = str1[s] ;
  8010c5:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8010c8:	8b 45 10             	mov    0x10(%ebp),%eax
  8010cb:	01 c2                	add    %eax,%edx
  8010cd:	8b 4d fc             	mov    -0x4(%ebp),%ecx
  8010d0:	8b 45 08             	mov    0x8(%ebp),%eax
  8010d3:	01 c8                	add    %ecx,%eax
...
strcconcat(const char *str1, const char *str2, char *final)
{
	...
	int s = 0 ;
	for (s=0 ; s < len1 ; s++)
  8010d9:	ff 45 fc             	incl   -0x4(%ebp)
  8010dc:	8b 45 fc             	mov    -0x4(%ebp),%eax
  8010df:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  8010e2:	7c e1                	jl     8010c5 <strcconcat+0x32>
		final[s] = str1[s] ;
  ...
  801119:	7c d9                	jl     8010f4 <strcconcat+0x61>
		final[s++] = str2[i] ;

	final[s] = 0;
  80111b:	8b 55 fc             	mov    -0x4(%ebp),%edx
...
int strsplit(char *string, char *SPLIT_CHARS, char **argv, int * argc)
{
  ...
  80113a:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  80114c:	eb 0c                	jmp    80115a <strsplit+0x31>
			*string++ = 0;
  ...
  801182:	74 5a                	je     8011de <strsplit+0xb5>
			break;
  ...
  801189:	83 f8 0f             	cmp    $0xf,%eax
  80118c:	75 07                	jne    801195 <strsplit+0x6c>
		{
			return 0;
  80118e:	b8 00 00 00 00       	mov    $0x0,%eax
  801193:	eb 66                	jmp    8011fb <strsplit+0xd2>
		}
  ...
  80119a:	8d 48 01             	lea    0x1(%eax),%ecx
  80119d:	8b 55 14             	mov    0x14(%ebp),%edx
  8011a0:	89 0a                	mov    %ecx,(%edx)
  ...
  8011b1:	89 02                	mov    %eax,(%edx)
		while (*string && !strchr(SPLIT_CHARS, *string))
  8011b3:	eb 03                	jmp    8011b8 <strsplit+0x8f>
			string++;
  ...
  8011bf:	74 8b                	je     80114c <strsplit+0x23>
  8011c1:	8b 45 08             	mov    0x8(%ebp),%eax
  8011c4:	8a 00                	mov    (%eax),%al
  8011c6:	0f be c0             	movsbl %al,%eax
  8011c9:	50                   	push   %eax
  8011ca:	ff 75 0c             	pushl  0xc(%ebp)
  8011cd:	e8 aa fa ff ff       	call   800c7c <strchr>
  8011d2:	83 c4 08             	add    $0x8,%esp
  8011d5:	85 c0                	test   %eax,%eax
  8011d7:	74 dc                	je     8011b5 <strsplit+0x8c>
			string++;
	}
  8011d9:	e9 6e ff ff ff       	jmp    80114c <strsplit+0x23>
		while (*string && strchr(SPLIT_CHARS, *string))
			*string++ = 0;
...
char* str2lower(char *dst, const char *src)
{
  ...
  801258:	75 c4                	jne    80121e <str2lower+0x21>
				*dst=*src;
			}
			src++;
			dst++;
