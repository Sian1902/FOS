...
_main(void)
{
  ...
  800053:	68 60 1b 80 00       	push   $0x801b60
  ...
  80006a:	68 62 1b 80 00       	push   $0x801b62
  ...
  800085:	50                   	push   %eax
  800086:	68 64 1b 80 00       	push   $0x801b64
...
libmain(int argc, char **argv)
{
  ...
  800118:	68 98 1b 80 00       	push   $0x801b98
  ...
  80016f:	52                   	push   %edx
  800170:	50                   	push   %eax
  800171:	68 e8 1b 80 00       	push   $0x801be8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80034c:	e8 8f 15 00 00       	call   8018e0 <__udivdi3>
  ...
  80039a:	52                   	push   %edx
  80039b:	50                   	push   %eax
  80039c:	e8 4f 16 00 00       	call   8019f0 <__umoddi3>
  8003a1:	83 c4 10             	add    $0x10,%esp
  8003a4:	05 74 1e 80 00       	add    $0x801e74,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8004f7:	8b 04 85 98 1e 80 00 	mov    0x801e98(,%eax,4),%eax
  ...
  8005d8:	8b 34 9d e0 1c 80 00 	mov    0x801ce0(,%ebx,4),%esi
  8005df:	85 f6                	test   %esi,%esi
  8005e1:	75 19                	jne    8005fc <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8005e3:	53                   	push   %ebx
  8005e4:	68 85 1e 80 00       	push   $0x801e85
  ...
  8005f7:	e9 49 02 00 00       	jmp    800845 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8005fc:	56                   	push   %esi
  8005fd:	68 8e 1e 80 00       	push   $0x801e8e
  ...
  800628:	75 05                	jne    80062f <vprintfmt+0x1a6>
				p = "(null)";
  80062a:	be 91 1e 80 00       	mov    $0x801e91,%esi
			if (width > 0 && padc != '-')
...
char* str2lower(char *dst, const char *src)
{
  ...
  801042:	68 f0 1f 80 00       	push   $0x801ff0
  801047:	68 3e 01 00 00       	push   $0x13e
  80104c:	68 17 20 80 00       	push   $0x802017
  801051:	e8 9e 06 00 00       	call   8016f4 <_panic>
...
void* sys_sbrk(int increment)
{
  ...
  8016ad:	e8 a4 f9 ff ff       	call   801056 <syscall>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8016cb:	6a 30                	push   $0x30
  8016cd:	e8 84 f9 ff ff       	call   801056 <syscall>
...
008016d8 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8016e7:	6a 31                	push   $0x31
  8016e9:	e8 68 f9 ff ff       	call   801056 <syscall>
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8016f7:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8016fa:	8d 45 10             	lea    0x10(%ebp),%eax
  8016fd:	83 c0 04             	add    $0x4,%eax
  801700:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  801703:	a1 18 31 80 00       	mov    0x803118,%eax
  801708:	85 c0                	test   %eax,%eax
  80170a:	74 16                	je     801722 <_panic+0x2e>
		cprintf("%s: ", argv0);
  80170c:	a1 18 31 80 00       	mov    0x803118,%eax
  801711:	83 ec 08             	sub    $0x8,%esp
  801714:	50                   	push   %eax
  801715:	68 24 20 80 00       	push   $0x802024
  80171a:	e8 90 eb ff ff       	call   8002af <cprintf>
  80171f:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  801722:	a1 00 30 80 00       	mov    0x803000,%eax
  801727:	ff 75 0c             	pushl  0xc(%ebp)
  80172a:	ff 75 08             	pushl  0x8(%ebp)
  80172d:	50                   	push   %eax
  80172e:	68 29 20 80 00       	push   $0x802029
  801733:	e8 77 eb ff ff       	call   8002af <cprintf>
  ...
  801744:	50                   	push   %eax
  801745:	e8 fa ea ff ff       	call   800244 <vcprintf>
  80174a:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  80174d:	83 ec 08             	sub    $0x8,%esp
  801750:	6a 00                	push   $0x0
  801752:	68 45 20 80 00       	push   $0x802045
  801757:	e8 e8 ea ff ff       	call   800244 <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  80175f:	e8 69 ea ff ff       	call   8001cd <exit>

	// should not return here
	while (1) ;
  801764:	eb fe                	jmp    801764 <_panic+0x70>

00801766 <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80176c:	a1 20 30 80 00       	mov    0x803020,%eax
  801771:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801777:	8b 45 0c             	mov    0xc(%ebp),%eax
  80177a:	39 c2                	cmp    %eax,%edx
  80177c:	74 14                	je     801792 <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  80177e:	83 ec 04             	sub    $0x4,%esp
  801781:	68 48 20 80 00       	push   $0x802048
  801786:	6a 26                	push   $0x26
  801788:	68 94 20 80 00       	push   $0x802094
  80178d:	e8 62 ff ff ff       	call   8016f4 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  801792:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  801799:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  8017a0:	e9 c5 00 00 00       	jmp    80186a <CheckWSArrayWithoutLastIndex+0x104>
		if (expectedPages[e] == 0) {
  8017a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8017a8:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  8017af:	8b 45 08             	mov    0x8(%ebp),%eax
  8017b2:	01 d0                	add    %edx,%eax
  8017b4:	8b 00                	mov    (%eax),%eax
  8017b6:	85 c0                	test   %eax,%eax
  8017b8:	75 08                	jne    8017c2 <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  8017ba:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  8017bd:	e9 a5 00 00 00       	jmp    801867 <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  8017c2:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  8017c9:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  8017d0:	eb 69                	jmp    80183b <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  8017d2:	a1 20 30 80 00       	mov    0x803020,%eax
  8017d7:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  8017dd:	8b 55 e8             	mov    -0x18(%ebp),%edx
  8017e0:	89 d0                	mov    %edx,%eax
  8017e2:	01 c0                	add    %eax,%eax
  8017e4:	01 d0                	add    %edx,%eax
  8017e6:	c1 e0 03             	shl    $0x3,%eax
  8017e9:	01 c8                	add    %ecx,%eax
  8017eb:	8a 40 04             	mov    0x4(%eax),%al
  8017ee:	84 c0                	test   %al,%al
  8017f0:	75 46                	jne    801838 <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  8017f2:	a1 20 30 80 00       	mov    0x803020,%eax
  8017f7:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  8017fd:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801800:	89 d0                	mov    %edx,%eax
  801802:	01 c0                	add    %eax,%eax
  801804:	01 d0                	add    %edx,%eax
  801806:	c1 e0 03             	shl    $0x3,%eax
  801809:	01 c8                	add    %ecx,%eax
  80180b:	8b 00                	mov    (%eax),%eax
  80180d:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801810:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801813:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801818:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  80181a:	8b 45 f0             	mov    -0x10(%ebp),%eax
  80181d:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801829:	8b 00                	mov    (%eax),%eax
		...
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
			if (myEnv->__uptr_pws[w].empty == 0) {
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  80182b:	39 c2                	cmp    %eax,%edx
  80182d:	75 09                	jne    801838 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  80182f:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801836:	eb 15                	jmp    80184d <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801838:	ff 45 e8             	incl   -0x18(%ebp)
  80183b:	a1 20 30 80 00       	mov    0x803020,%eax
  801840:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801846:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801849:	39 c2                	cmp    %eax,%edx
  80184b:	77 85                	ja     8017d2 <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
  ...
  801851:	75 14                	jne    801867 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  801853:	83 ec 04             	sub    $0x4,%esp
  801856:	68 a0 20 80 00       	push   $0x8020a0
  80185b:	6a 3a                	push   $0x3a
  80185d:	68 94 20 80 00       	push   $0x802094
  801862:	e8 8d fe ff ff       	call   8016f4 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
  ...
  80186d:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801870:	0f 8c 2f ff ff ff    	jl     8017a5 <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  801876:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  80187d:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801884:	eb 26                	jmp    8018ac <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801886:	a1 20 30 80 00       	mov    0x803020,%eax
  80188b:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  801891:	8b 55 e0             	mov    -0x20(%ebp),%edx
  ...
  8018a4:	75 03                	jne    8018a9 <CheckWSArrayWithoutLastIndex+0x143>
  ...
  8018b1:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  8018b7:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8018ba:	39 c2                	cmp    %eax,%edx
  8018bc:	77 c8                	ja     801886 <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  8018c1:	3b 45 e4             	cmp    -0x1c(%ebp),%eax
  8018c4:	74 14                	je     8018da <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  8018c6:	83 ec 04             	sub    $0x4,%esp
  8018c9:	68 f4 20 80 00       	push   $0x8020f4
  8018ce:	6a 44                	push   $0x44
  8018d0:	68 94 20 80 00       	push   $0x802094
  8018d5:	e8 1a fe ff ff       	call   8016f4 <_panic>
