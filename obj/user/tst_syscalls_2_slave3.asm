...
_main(void)
{
  ...
  80004b:	e8 73 18 00 00       	call   8018c3 <sys_free_user_mem>
  800050:	83 c4 10             	add    $0x10,%esp
	inctst();
  800053:	e8 bd 16 00 00       	call   801715 <inctst>
...
libmain(int argc, char **argv)
{
  ...
  800072:	e8 60 15 00 00       	call   8015d7 <sys_getenvindex>
  ...
  8000e6:	e8 f9 12 00 00       	call   8013e4 <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  800180:	e8 79 12 00 00       	call   8013fe <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800198:	e8 06 14 00 00       	call   8015a3 <sys_destroy_env>
...
exit(void)
{
  ...
  8001a6:	83 ec 08             	sub    $0x8,%esp
	sys_exit_env();
  8001a9:	e8 5b 14 00 00       	call   801609 <sys_exit_env>
}
  8001ae:	90                   	nop
  8001af:	c9                   	leave  
  8001b0:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  8003de:	51                   	push   %ecx
  8003df:	52                   	push   %edx
  8003e0:	e8 a6 0e 00 00       	call   80128b <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800456:	50                   	push   %eax
  800457:	e8 2f 0e 00 00       	call   80128b <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80049e:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8004a1:	e8 3e 0f 00 00       	call   8013e4 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8004be:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8004c1:	e8 38 0f 00 00       	call   8013fe <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80050b:	e8 f0 13 00 00       	call   801900 <__udivdi3>
  ...
  800559:	52                   	push   %edx
  80055a:	50                   	push   %eax
  80055b:	e8 b0 14 00 00       	call   801a10 <__umoddi3>
...
char* str2lower(char *dst, const char *src)
{
  ...
  801253:	75 c4                	jne    801219 <str2lower+0x21>
				*dst=*src;
			}
			src++;
			dst++;
...
void* sys_sbrk(int increment)
{
  ...
  8018af:	68 b0 21 80 00       	push   $0x8021b0
  8018b4:	68 54 01 00 00       	push   $0x154
  8018b9:	68 c4 21 80 00       	push   $0x8021c4
  8018be:	e8 ee e8 ff ff       	call   8001b1 <_panic>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8018cc:	68 b0 21 80 00       	push   $0x8021b0
  8018d1:	68 5b 01 00 00       	push   $0x15b
  8018d6:	68 c4 21 80 00       	push   $0x8021c4
  8018db:	e8 d1 e8 ff ff       	call   8001b1 <_panic>
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8018e9:	68 b0 21 80 00       	push   $0x8021b0
  8018ee:	68 61 01 00 00       	push   $0x161
  8018f3:	68 c4 21 80 00       	push   $0x8021c4
  8018f8:	e8 b4 e8 ff ff       	call   8001b1 <_panic>
