...
_main(void)
{
  ...
  80004b:	e8 71 18 00 00       	call   8018c1 <sys_free_user_mem>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80050b:	e8 ec 13 00 00       	call   8018fc <__udivdi3>
  ...
  800559:	52                   	push   %edx
  80055a:	50                   	push   %eax
  80055b:	e8 ac 14 00 00       	call   801a0c <__umoddi3>
