...
_main(void)
{
  ...
  80004b:	e8 2b 18 00 00       	call   80187b <sys_free_user_mem>
...
void* sys_sbrk(int increment)
{
  ...
  801869:	50                   	push   %eax
  80186a:	6a 2f                	push   $0x2f
  80186c:	e8 a4 f9 ff ff       	call   801215 <syscall>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  80188a:	6a 30                	push   $0x30
  80188c:	e8 84 f9 ff ff       	call   801215 <syscall>
...
00801897 <sys_allocate_user_mem>:
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  8018a6:	6a 31                	push   $0x31
  8018a8:	e8 68 f9 ff ff       	call   801215 <syscall>
