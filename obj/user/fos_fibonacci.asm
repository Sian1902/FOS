...
void readline(const char *prompt, char* buf)
{
  ...
  8009a7:	e8 2f 10 00 00       	call   8019db <iscons>
  8009ac:	83 c4 10             	add    $0x10,%esp
  8009af:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  8009b2:	e8 d6 0f 00 00       	call   80198d <getchar>
  ...
  8009fd:	e8 43 0f 00 00       	call   801945 <cputchar>
  ...
  800a34:	e8 0c 0f 00 00       	call   801945 <cputchar>
  ...
  800a5d:	e8 e3 0e 00 00       	call   801945 <cputchar>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  800aaa:	e8 2c 0f 00 00       	call   8019db <iscons>
  800aaf:	83 c4 10             	add    $0x10,%esp
  800ab2:	89 45 f0             	mov    %eax,-0x10(%ebp)
	while (1) {
		c = getchar();
  800ab5:	e8 d3 0e 00 00       	call   80198d <getchar>
  ...
  800b01:	e8 3f 0e 00 00       	call   801945 <cputchar>
  ...
  800b38:	e8 08 0e 00 00       	call   801945 <cputchar>
  ...
  800b61:	e8 df 0d 00 00       	call   801945 <cputchar>
...
char* str2lower(char *dst, const char *src)
{
  ...
  8012a2:	e8 3e 07 00 00       	call   8019e5 <_panic>
...
void sys_free_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  80191e:	e8 84 f9 ff ff       	call   8012a7 <syscall>
...
void sys_allocate_user_mem(uint32 virtual_address, uint32 size)
{
  ...
  801938:	6a 31                	push   $0x31
  80193a:	e8 68 f9 ff ff       	call   8012a7 <syscall>
...
cputchar(int ch)
{
  ...
  801958:	50                   	push   %eax
  801959:	e8 01 fb ff ff       	call   80145f <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  801967:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80196a:	e8 bc fa ff ff       	call   80142b <sys_disable_interrupt>
	char c = ch;
  ...
  801972:	88 45 f7             	mov    %al,-0x9(%ebp)
	...
	sys_cputc(c);
  801975:	0f be 45 f7          	movsbl -0x9(%ebp),%eax
  801979:	83 ec 0c             	sub    $0xc,%esp
  80197c:	50                   	push   %eax
  80197d:	e8 dd fa ff ff       	call   80145f <sys_cputc>
  801982:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  801985:	e8 bb fa ff ff       	call   801445 <sys_enable_interrupt>
}
  80198a:	90                   	nop
  80198b:	c9                   	leave  
  80198c:	c3                   	ret    
...
getchar(void)
{
  ...
  801993:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  80199a:	eb 08                	jmp    8019a4 <getchar+0x17>
	{
		c = sys_cgetc();
  80199c:	e8 5a f9 ff ff       	call   8012fb <sys_cgetc>
...
getchar(void)
{
	...
	int c=0;
	while(c == 0)
  8019a4:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8019a8:	74 f2                	je     80199c <getchar+0xf>
	{
		c = sys_cgetc();
	}
	return c;
...
atomic_getchar(void)
{
  ...
  8019b2:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8019b5:	e8 71 fa ff ff       	call   80142b <sys_disable_interrupt>
	int c=0;
  8019ba:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	while(c == 0)
  8019c1:	eb 08                	jmp    8019cb <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  8019c3:	e8 33 f9 ff ff       	call   8012fb <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  8019cf:	74 f2                	je     8019c3 <atomic_getchar+0x14>
	{
		c = sys_cgetc();
	}
	sys_enable_interrupt();
  8019d1:	e8 6f fa ff ff       	call   801445 <sys_enable_interrupt>
	return c;
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8019e8:	83 ec 18             	sub    $0x18,%esp
	va_list ap;
	va_start(ap, fmt);
  8019eb:	8d 45 10             	lea    0x10(%ebp),%eax
  8019ee:	83 c0 04             	add    $0x4,%eax
  8019f1:	89 45 f4             	mov    %eax,-0xc(%ebp)
	// Print the panic message
	if (argv0)
  8019f4:	a1 18 31 80 00       	mov    0x803118,%eax
  8019f9:	85 c0                	test   %eax,%eax
  8019fb:	74 16                	je     801a13 <_panic+0x2e>
		cprintf("%s: ", argv0);
  8019fd:	a1 18 31 80 00       	mov    0x803118,%eax
  801a02:	83 ec 08             	sub    $0x8,%esp
  801a05:	50                   	push   %eax
  801a06:	68 38 23 80 00       	push   $0x802338
  801a0b:	e8 ea e8 ff ff       	call   8002fa <cprintf>
  801a10:	83 c4 10             	add    $0x10,%esp
	cprintf("user panic in %s at %s:%d: ", binaryname, file, line);
  801a13:	a1 00 30 80 00       	mov    0x803000,%eax
  801a18:	ff 75 0c             	pushl  0xc(%ebp)
  801a1b:	ff 75 08             	pushl  0x8(%ebp)
  801a1e:	50                   	push   %eax
  801a1f:	68 3d 23 80 00       	push   $0x80233d
  801a24:	e8 d1 e8 ff ff       	call   8002fa <cprintf>
  ...
  801a35:	50                   	push   %eax
  801a36:	e8 54 e8 ff ff       	call   80028f <vcprintf>
  801a3b:	83 c4 10             	add    $0x10,%esp
	vcprintf("\n", NULL);
  801a3e:	83 ec 08             	sub    $0x8,%esp
  801a41:	6a 00                	push   $0x0
  801a43:	68 59 23 80 00       	push   $0x802359
  801a48:	e8 42 e8 ff ff       	call   80028f <vcprintf>
...
//		asm volatile("int3");
	...
	exit() ;
  801a50:	e8 c3 e7 ff ff       	call   800218 <exit>

	// should not return here
	while (1) ;
  801a55:	eb fe                	jmp    801a55 <_panic+0x70>

00801a57 <CheckWSArrayWithoutLastIndex>:
}
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  801a5d:	a1 20 30 80 00       	mov    0x803020,%eax
  801a62:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801a68:	8b 45 0c             	mov    0xc(%ebp),%eax
  801a6b:	39 c2                	cmp    %eax,%edx
  801a6d:	74 14                	je     801a83 <CheckWSArrayWithoutLastIndex+0x2c>
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
  801a6f:	83 ec 04             	sub    $0x4,%esp
  801a72:	68 5c 23 80 00       	push   $0x80235c
  801a77:	6a 26                	push   $0x26
  801a79:	68 a8 23 80 00       	push   $0x8023a8
  801a7e:	e8 62 ff ff ff       	call   8019e5 <_panic>
	}
	int expectedNumOfEmptyLocs = 0;
  801a83:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
	for (int e = 0; e < arraySize; e++) {
  801a8a:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  801a91:	e9 c5 00 00 00       	jmp    801b5b <CheckWSArrayWithoutLastIndex+0x104>
  ...
  801aa9:	75 08                	jne    801ab3 <CheckWSArrayWithoutLastIndex+0x5c>
			expectedNumOfEmptyLocs++;
  801aab:	ff 45 f4             	incl   -0xc(%ebp)
			continue;
  801aae:	e9 a5 00 00 00       	jmp    801b58 <CheckWSArrayWithoutLastIndex+0x101>
		}
		int found = 0;
  801ab3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801aba:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%ebp)
  801ac1:	eb 69                	jmp    801b2c <CheckWSArrayWithoutLastIndex+0xd5>
			if (myEnv->__uptr_pws[w].empty == 0) {
  801ac3:	a1 20 30 80 00       	mov    0x803020,%eax
  801ac8:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  801ace:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801ad1:	89 d0                	mov    %edx,%eax
  801ad3:	01 c0                	add    %eax,%eax
  801ad5:	01 d0                	add    %edx,%eax
  801ad7:	c1 e0 03             	shl    $0x3,%eax
  801ada:	01 c8                	add    %ecx,%eax
  801adc:	8a 40 04             	mov    0x4(%eax),%al
  801adf:	84 c0                	test   %al,%al
  801ae1:	75 46                	jne    801b29 <CheckWSArrayWithoutLastIndex+0xd2>
				if (ROUNDDOWN(myEnv->__uptr_pws[w].virtual_address, PAGE_SIZE)
  801ae3:	a1 20 30 80 00       	mov    0x803020,%eax
  801ae8:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  801aee:	8b 55 e8             	mov    -0x18(%ebp),%edx
  801af1:	89 d0                	mov    %edx,%eax
  801af3:	01 c0                	add    %eax,%eax
  801af5:	01 d0                	add    %edx,%eax
  801af7:	c1 e0 03             	shl    $0x3,%eax
  801afa:	01 c8                	add    %ecx,%eax
  801afc:	8b 00                	mov    (%eax),%eax
  801afe:	89 45 dc             	mov    %eax,-0x24(%ebp)
  801b01:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801b04:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  801b09:	89 c2                	mov    %eax,%edx
						== expectedPages[e]) {
  801b0b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b0e:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
  ...
  801b1e:	75 09                	jne    801b29 <CheckWSArrayWithoutLastIndex+0xd2>
						== expectedPages[e]) {
					found = 1;
  801b20:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%ebp)
					break;
  801b27:	eb 15                	jmp    801b3e <CheckWSArrayWithoutLastIndex+0xe7>
		if (expectedPages[e] == 0) {
			expectedNumOfEmptyLocs++;
			continue;
		}
		int found = 0;
		for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b29:	ff 45 e8             	incl   -0x18(%ebp)
  801b2c:	a1 20 30 80 00       	mov    0x803020,%eax
  801b31:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801b37:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801b3a:	39 c2                	cmp    %eax,%edx
  801b3c:	77 85                	ja     801ac3 <CheckWSArrayWithoutLastIndex+0x6c>
					found = 1;
					break;
				}
			}
		...
		if (!found)
  801b3e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
  801b42:	75 14                	jne    801b58 <CheckWSArrayWithoutLastIndex+0x101>
			panic(
  801b44:	83 ec 04             	sub    $0x4,%esp
  801b47:	68 b4 23 80 00       	push   $0x8023b4
  801b4c:	6a 3a                	push   $0x3a
  801b4e:	68 a8 23 80 00       	push   $0x8023a8
  801b53:	e8 8d fe ff ff       	call   8019e5 <_panic>
	if (arraySize != myEnv->page_WS_max_size)
	{
		panic("number of expected pages SHOULD BE EQUAL to max WS size... review your TA!!");
	}
	int expectedNumOfEmptyLocs = 0;
	for (int e = 0; e < arraySize; e++) {
  801b58:	ff 45 f0             	incl   -0x10(%ebp)
  801b5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801b5e:	3b 45 0c             	cmp    0xc(%ebp),%eax
  801b61:	0f 8c 2f ff ff ff    	jl     801a96 <CheckWSArrayWithoutLastIndex+0x3f>
		}
		if (!found)
			panic(
  ...
  801b67:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b6e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
  801b75:	eb 26                	jmp    801b9d <CheckWSArrayWithoutLastIndex+0x146>
		if (myEnv->__uptr_pws[w].empty == 1) {
  801b77:	a1 20 30 80 00       	mov    0x803020,%eax
  801b7c:	8b 88 6c da 01 00    	mov    0x1da6c(%eax),%ecx
  801b82:	8b 55 e0             	mov    -0x20(%ebp),%edx
  801b85:	89 d0                	mov    %edx,%eax
  801b87:	01 c0                	add    %eax,%eax
  801b89:	01 d0                	add    %edx,%eax
  801b8b:	c1 e0 03             	shl    $0x3,%eax
  801b8e:	01 c8                	add    %ecx,%eax
  801b90:	8a 40 04             	mov    0x4(%eax),%al
  801b93:	3c 01                	cmp    $0x1,%al
  801b95:	75 03                	jne    801b9a <CheckWSArrayWithoutLastIndex+0x143>
			actualNumOfEmptyLocs++;
  801b97:	ff 45 e4             	incl   -0x1c(%ebp)
		if (!found)
			panic(
					"PAGE WS entry checking failed... trace it by printing page WS before & after fault");
	}
	int actualNumOfEmptyLocs = 0;
	for (int w = 0; w < myEnv->page_WS_max_size; w++) {
  801b9a:	ff 45 e0             	incl   -0x20(%ebp)
  801b9d:	a1 20 30 80 00       	mov    0x803020,%eax
  801ba2:	8b 90 7c d5 01 00    	mov    0x1d57c(%eax),%edx
  801ba8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  801bab:	39 c2                	cmp    %eax,%edx
  801bad:	77 c8                	ja     801b77 <CheckWSArrayWithoutLastIndex+0x120>
		if (myEnv->__uptr_pws[w].empty == 1) {
			actualNumOfEmptyLocs++;
		}
	}
  ...
  801bb5:	74 14                	je     801bcb <CheckWSArrayWithoutLastIndex+0x174>
		panic(
  801bb7:	83 ec 04             	sub    $0x4,%esp
  801bba:	68 08 24 80 00       	push   $0x802408
  801bbf:	6a 44                	push   $0x44
  801bc1:	68 a8 23 80 00       	push   $0x8023a8
  801bc6:	e8 1a fe ff ff       	call   8019e5 <_panic>
